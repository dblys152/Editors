...
(function ($) {
  ...
  function TagsInput(element, options) {
    ...
    this.$container = $('<div class="bootstrap-tagsinput overflow-auto"></div>');
    this.$input = $('<input type="' + this.type + '" name="' + this.name + '" placeholder="' + this.placeholderText + '" maxlength="20"/>').appendTo(this.$container);
